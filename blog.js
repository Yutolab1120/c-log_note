...
with (document) {
    write('<h3>' + 'スマホから投稿してみるー' + '</h3>');
    write('<h6>' + '2021年01月04日' + '</h6>' + '<br>');
    write(
        '<p>こんにちは🌞スマホから投稿してみてます。@Yutolab1120です！</p>',
        '<p>タイトル通り、スマホからブログ投稿してみようと試みてます、、、</p>',
　　　　　'<p>実際書いてみると、うん。面倒臭いね。</p>',
　　　　　'<p>GitHubのコード編集も、ね、なんかやりにくい。</p>',
　　　　　'<p>あ、でも、スマホ用のコードエディタがあったらやりやすくなるかもw</p>',
　　　　　'<p>まぁ。こんな感じです、、、</p>',
　　　　　'<p>次はサービス開発の話を書こうと思います。</p>',
　　　　　'<p>それじゃ、また今度ー！</p>' + '<br>'
    );
}
